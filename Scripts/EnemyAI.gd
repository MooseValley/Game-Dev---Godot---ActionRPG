...
# Make sure you have 
# AnimatedSprite -> CanvasItem -> Resource -> Local To Scene 
# checked, otherwise all of the bats blink and become invincible if one bat is hit.
# Might be a useful technique for BOSS Bats !!
...
func _on_Hurtbox_area_entered(area):
	...
	enemyHurtbox.start_invincibility(INVINCIBLE_DURATION)
